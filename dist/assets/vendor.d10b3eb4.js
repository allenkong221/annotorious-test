 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qh{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Gh(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function Gh(e){const t=e.getComponent();return(t==null?void 0:t.type)==="VERSION"}const Ic="@firebase/app",Jh="0.7.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ug(e=Cp()){const t=Tc(e,"auth");return t.isInitialized()?t.getImmediate():Op(e,{popupRedirectResolver:fg,persistence:[Im,um,Qc]})}gg("Browser");function Fg(e,t){return e.then(function(n){return[null,n]}).catch(function(n){return t&&Object.assign(n,t),[n,void 0]})}var _g="firebase",vg="9.1.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */Ws(_g,vg,"app");var yg=!1;/*!
  ...
  * (c) 2021 Eduardo San Martin Morote
  * @license MIT
  */const bg=Symbol();var hl;(function(e){e.direct="direct",e.patchObject="patch object",e.patchFunction="patch function"})(hl||(hl={}));function Bg(){const e=Rl(!0),t=e.run(()=>yo({}));let n=[];const s=[],r=Er({install(i){r._a=i,i.provide(bg,r),i.config.globalProperties.$pinia=r,s.forEach(o=>n.push(o))},use(i){return!this._a&&!yg?s.push(i):n.push(i),this},_p:n,_a:null,_e:e,_s:new Map,state:t});return r}export{Hu as A,$f as B,Is as C,xg as D,Ug as E,be as F,Fg as G,$g as H,Dg as I,kg as J,Pg as K,Bf as L,Bg as M,Cg as N,Ag as O,Eg as P,Ig as Q,tu as R,Og as S,wa as T,Lg as V,fe as a,ea as b,Rg as c,Sg as d,et as e,Ng as f,yo as g,_u as h,Ke as i,Oo as j,ta as k,or as l,qt as m,Wr as n,de as o,he as p,Lr as q,En as r,ir as s,Vi as t,Mg as u,wg as v,As as w,Tg as x,vn as y,xr as z};
