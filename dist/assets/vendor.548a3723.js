 ...
 */un(Lm,xm,"app");var Um=!1;/*!
  ...
  * (c) 2021 Eduardo San Martin Morote
  * @license MIT
  */const Fm=Symbol();var vl;(function(e){e.direct="direct",e.patchObject="patch object",e.patchFunction="patch function"})(vl||(vl={}));function rv(){const e=kl(!0),t=e.run(()=>ao({}));let n=[],r=[];const s=ys({install(i){s._a=i,i.provide(Fm,s),i.config.globalProperties.$pinia=s,r.forEach(o=>n.push(o)),r=[]},use(i){return!this._a&&!Um?r.push(i):n.push(i),this},_p:n,_a:null,_e:e,_s:new Map,state:t});return s}export{Hm as A,Vm as B,Tr as C,ev as D,tv as E,ye as F,Qm as G,Jm as H,Gm as I,Kf as J,Zm as K,rv as L,jm as M,Wm as N,Bm as O,$m as P,ou as Q,qm as R,Km as S,fa as T,nv as U,we as V,_e as a,zm as b,Be as c,Nt as d,nt as e,Ym as f,ao as g,Iu as h,Ke as i,_o as j,Xt as k,jo as l,ft as m,Vs as n,de as o,Ge as p,Ns as q,Cn as r,mn as s,ki as t,Xm as u,In as v,Or as w,Ds as x,Ku as y,jf as z};
